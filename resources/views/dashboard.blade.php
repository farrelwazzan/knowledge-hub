    <x-app-layout>
        ...
        <div class="min-h-screen bg-[#ececf2] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
            <div class="mx-auto w-full max-w-5xl">
                ...
                >
                    <x-slot:action>
                        <x-button href="{{ route('knowledge.create', ['from' => 'dashboard']) }}">
                            + Add Knowledge
                        </x-button>
                    </x-slot:action>
                </x-page-header>
                ...
                @else
                    ...
                    <div class="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        {{-- Total Knowledge --}}
                        <x-card class="p-5 bg-[#505278]">
                            <div class="flex items-start justify-between">

                                <div>
                                    <p class="text-xs font-medium uppercase tracking-wide text-[#d5d6e2]">
                                        Total Knowledge
                                    </p>

                                    <p class="mt-2 text-4xl font-semibold text-[#f6f6f9]">
                                        {{ $totalKnowledge }}
                                    </p>

                                    <p class="mt-1 text-sm text-[#afb1ca]">
                                        Knowledge entries
                                    </p>
                                </div>

                                <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-[#d5d6e2]/10 text-[#d5d6e2]">
                                    <svg
